...
Under the `tags` directory in the repository you will find every JSON file representing a tag. For example, the `how2ask` tag is stored in `tags/how2ask.json`.
